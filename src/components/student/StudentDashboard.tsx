  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      {wasAuthorizedRecently && (
        <div className="p-4 bg-emerald-500 text-white rounded-2xl shadow-md border-2 border-emerald-400 flex items-center justify-between animate-pulse">
          <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-brand-900 text-white rounded-xl text-xs font-bold shadow-md hover:bg-brand-800 transition-colors shrink-0"
          >
      ...
      {activeClass && (
        <div className="bg-gradient-to-r from-brand-900 to-brand-800 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/20 text-center min-w-[200px] shrink-0">
              <span className="text-[11px] text-white/70 uppercase tracking-wider font-semibold block mb-1">
                Estado del Puesto
              </span>
              ...
              <div className="w-full bg-black/30 rounded-full h-2 overflow-hidden border border-white/10">
                <div
                  className={`h-full transition-all duration-500 ${
                    isComplete ? 'bg-emerald-400' : 'bg-red-400'
                  }`}
      ...
      {activeTab === 'registro' && (
        <div className="space-y-6">
          {/* Instructions bar */}
          <div className="bg-brand-900/5 border border-brand-700/30 rounded-xl p-3.5 text-xs text-brand-900 flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              <QrCode className="w-5 h-5 text-brand-900 shrink-0" />
              <span>
            ...
            <span className="font-bold text-brand-900 bg-white px-2.5 py-1 rounded-lg border border-brand-700/30 shrink-0 ml-2">
                ...
                <div
                  ...
                  className={`rounded-2xl border transition-all duration-200 p-5 flex flex-col justify-between relative overflow-hidden bg-white shadow-xs ${
                    isRegistered
                      ...
                      : 'border-slate-300 hover:border-brand-700'
                  }`}
                >
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="font-mono font-bold text-brand-900 hover:underline flex items-center gap-1"
                          >
                  ...
                  <div className="mt-2 pt-1">
                    {isRegistered ? (
                      ...
                      <button
                        type="button"
                        onClick={() => handleOpenScanner(slot.type)}
                        className="w-full py-2.5 bg-brand-900 hover:bg-brand-800 text-white rounded-xl text-xs font-bold transition-all shadow-sm flex items-center justify-center space-x-2 group cursor-pointer"
                      >
          ...
          <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-center">
              ...
              >
                <RotateCcw className="w-3.5 h-3.5 text-brand-900" />
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95 duration-150">
            ...
            <form onSubmit={handleSendChangeRequest} className="space-y-4 text-xs">
              ...
              <div className="flex items-center justify-end space-x-2 pt-2 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-brand-900 hover:bg-brand-800 text-white rounded-xl font-bold transition-colors shadow-sm"
                >
