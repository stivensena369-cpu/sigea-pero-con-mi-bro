            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="flex justify-end space-x-2">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold shadow-md transition-colors flex items-center space-x-2"
                >
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs space-y-6">
          ...
          <form onSubmit={handleGenerateClassesSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
            ...
            <div className="sm:col-span-2 lg:col-span-3 pt-2">
              <button
                type="submit"
                className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold shadow-md transition-colors flex items-center space-x-2"
              >
