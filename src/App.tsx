    ...
    return (
      <div className="min-h-screen bg-slate-100 flex flex-col justify-between font-sans">
        ...
        <footer className="py-4 text-center text-xs text-slate-500 border-t border-slate-200 bg-white">
          <p>© 2026 SIGEA - Sistema Integral de Gestión de Entornos y Activos. Prototipo Demostrativo MVP.</p>
        </footer>
      </div>
    );
  }
      ...
      <footer className="bg-white border-t border-slate-200 py-6 text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-2">
            <div className="w-6 h-6 rounded bg-[#004481] text-white flex items-center justify-center font-black text-xs">
              S
            </div>
            <span className="font-bold text-slate-800">SIGEA • Gestión de Entornos y Activos</span>
            <span className="text-slate-300">|</span>
            <span>Versión Prototipo Demostrativo</span>
          </div>
          ...
          <div className="flex items-center space-x-4 text-[11px] text-slate-600">
            ...
            <button
              ...
              className="text-[#004481] hover:underline font-semibold flex items-center gap-1"
            >
              <RefreshCw className="w-3 h-3 text-[#F9A800]" />
